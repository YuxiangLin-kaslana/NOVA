...
#SBATCH --output=sigla-mimic-%j.out
#SBATCH --error=sigla-mimic-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" mimic/exp_mimic_fusion.py
echo mimic-done
