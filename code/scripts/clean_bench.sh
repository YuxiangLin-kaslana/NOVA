...
#SBATCH --output=sigla-cb-%j.out
#SBATCH --error=sigla-cb-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" scripts/clean_bench.py
echo done
