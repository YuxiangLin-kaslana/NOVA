...
#SBATCH --output=sigla-nacc-%j.out
#SBATCH --error=sigla-nacc-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" scripts/diag_naming_acc.py
echo done
