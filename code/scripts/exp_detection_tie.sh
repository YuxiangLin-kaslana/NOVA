...
#SBATCH --output=sigla-ovd-%j.out
#SBATCH --error=sigla-ovd-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" scripts/exp_detection_tie.py
echo done
