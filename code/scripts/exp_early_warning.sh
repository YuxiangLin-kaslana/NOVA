...
#SBATCH --output=sigla-ove-%j.out
#SBATCH --error=sigla-ove-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" scripts/exp_early_warning.py
echo done
