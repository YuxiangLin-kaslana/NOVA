...
#SBATCH --output=sigla-ovm-%j.out
#SBATCH --error=sigla-ovm-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" scripts/exp_openvocab_multi.py
echo done
