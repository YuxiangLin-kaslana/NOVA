...
#SBATCH --output=sigla-diag-%j.out
#SBATCH --error=sigla-diag-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/diag_memstream.py
echo diag-done
