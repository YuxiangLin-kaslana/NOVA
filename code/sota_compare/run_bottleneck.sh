...
#SBATCH --output=sigla-btl-%j.out
#SBATCH --error=sigla-btl-%j.err
set -euo pipefail
...
echo "##### synthetic #####"; "${PY}" sota_compare/exp_signal_bottleneck.py
echo "##### real machine-1-1 #####"; REAL_MACHINE=1-1 "${PY}" sota_compare/exp_signal_bottleneck.py
echo btl-done
