...
#SBATCH --output=sigla-sota-%j.out
#SBATCH --error=sigla-sota-%j.err
set -euo pipefail
...
# 冒烟(CMP_SMOKE=1 时 1 seed、极小规模,先验证 shape/流程);否则全量
"${PY}" sota_compare/run_detection_compare.py
echo done
