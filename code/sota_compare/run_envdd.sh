...
#SBATCH --output=sigla-envdd-%j.out
#SBATCH --error=sigla-envdd-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/exp_env_deepdive.py
echo envdd-done
