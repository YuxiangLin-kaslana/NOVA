...
#SBATCH --output=sigla-sota-ew-%j.out
#SBATCH --error=sigla-sota-ew-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/run_ew_compare.py
echo done
