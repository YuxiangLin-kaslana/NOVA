#!/bin/bash
#SBATCH --job-name=sigla-p2-guard
...
#SBATCH --output=sigla-p2-guard-%j.out
#SBATCH --error=sigla-p2-guard-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/run_guard_sweep.py
echo done
