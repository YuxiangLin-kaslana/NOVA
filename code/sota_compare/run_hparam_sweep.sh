#!/bin/bash
#SBATCH --job-name=sigla-p2-hparam
...
#SBATCH --output=sigla-p2-hparam-%j.out
#SBATCH --error=sigla-p2-hparam-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/run_hparam_sweep.py
echo done
