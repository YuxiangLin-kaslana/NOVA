...
#SBATCH --output=sigla-mmd-%j.out
#SBATCH --error=sigla-mmd-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/exp_mmd_earlywarning.py
echo mmd-done
