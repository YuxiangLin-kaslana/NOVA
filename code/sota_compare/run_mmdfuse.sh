...
#SBATCH --output=sigla-mmf-%j.out
#SBATCH --error=sigla-mmf-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/exp_mmd_fusion.py
echo mmf-done
