...
#SBATCH --output=sigla-mmf2-%j.out
#SBATCH --error=sigla-mmf2-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/exp_mmd_fusion2.py
echo mmf2-done
