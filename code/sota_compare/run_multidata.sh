...
#SBATCH --output=sigla-multi-%j.out
#SBATCH --error=sigla-multi-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/run_multidata.py
echo done
