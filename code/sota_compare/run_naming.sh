...
#SBATCH --output=sigla-naming-%j.out
#SBATCH --error=sigla-naming-%j.err
set -euo pipefail
...
echo "===== real machine-1-1 ====="; REAL_MACHINE=1-1 "${PY}" sota_compare/exp_naming_baseline.py
echo done
