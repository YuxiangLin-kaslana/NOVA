...
#SBATCH --output=sigla-rmulti-%j.out
#SBATCH --error=sigla-rmulti-%j.err
set -euo pipefail
...
"/projects/bflz/ylin30/conda_envs/sigla/bin/python" sota_compare/run_robust_multi.py
echo done
